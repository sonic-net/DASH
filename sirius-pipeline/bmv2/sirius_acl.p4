...
#define ACL_STAGE(table_name) \
    ...
    table table_name { \
        key = { \
            ...
            hdr.ipv4.protocol : ternary @name("hdr.ipv4.src_addr:protocol"); \
            meta.flow.src_port : ternary @name("meta.flow.src_port:sport"); \
            meta.flow.dst_port : ternary @name("meta.flow.dst_port:dport"); \
        } \
        actions = { \
            permit; \
            permit_and_continue; \
