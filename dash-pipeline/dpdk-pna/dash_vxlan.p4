...
action vxlan_encap(inout headers_t hdr,
    ...
    // p4c-dpdk as of 2023-Jan-26 seems like it does not support
    // multplication of run-time variable values.  It does support if
    // statements inside of P4 action bodies, so I will edit this code
    // to use that instead.
