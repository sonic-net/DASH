...
class SAIGenerator:
    ...
    def generate_dash_sai_definitions_for_api(self, sai_api: DASHAPISet) -> None:
        ...
        SAITemplateRenderer('templates/saiapi.h.j2').render_to_file('SAI/experimental/' + sai_header_file_name, sai_api = sai_api)
    ...
    def generate_sai_impl_file_for_api(self, sai_api: DASHAPISet) -> None:
        ...
        SAITemplateRenderer('templates/saiapi.cpp.j2').render_to_file('lib/' + sai_impl_file_name, tables = sai_api.tables, app_name = sai_api.app_name, header_prefix = header_prefix)
    ...
    def generate_sai_port_extensions(self) -> None:
        ...
        new_port_counters: List[SAIAPICounter] = []
        new_port_stats: List[SAIAPICounter] = []
        is_first_attr = False
        is_first_stat = False
        ...
        sai_counters_str = SAITemplateRenderer('templates/saicounter.j2').render(table_name = "port", sai_counters = new_port_counters, is_first_attr = is_first_attr)
        ...
        sai_stats_str = SAITemplateRenderer('templates/headers/sai_stats_extensions.j2').render(table_name = "port", sai_stats = new_port_stats, is_first_attr = is_first_stat)
    ...
    def generate_sai_enum_extensions(self) -> None:
        ...
        sai_enums_str = SAITemplateRenderer('templates/saienums.j2').render(sai_enums = new_sai_enums)
    ...
    def generate_sai_fixed_api_files(self) -> None:
        ...
        for filename in ['saifixedapis.cpp', 'saiimpl.h']:
            SAITemplateRenderer('templates/%s.j2' % filename).render_to_file('lib/%s' % filename, api_names = self.sai_api_names)
