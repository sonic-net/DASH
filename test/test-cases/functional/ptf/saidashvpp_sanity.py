...
class SaiThriftVppPktTest(SaiHelperSimplified):
    """ Test saithrift vnet outbound towards vpp"""

    def setUp(self):
        super(SaiThriftVppPktTest, self).setUp()
        self.switch_id = 5
    ...
    def trafficTcpTest(self):
        ...
        print ("SaiThriftVppTcpPktTest OK")
    ...
    def tearDown(self):
        ...
        try:
            ...
            super(SaiThriftVppPktTest, self).tearDown()
